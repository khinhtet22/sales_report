...
The objective is to **optimize revenue while balancing sales effort and efficiency** using data-driven insights.
...
- **Call-only** showed the lowest efficiency  
...
## ✍️ Author
**Khin Htet**  
*Sales & Business Data Analysis (Python)*  
